...
export default function Navigation({ children }: { children: React.ReactNode; }) {
    ...
    return (
        <div className="flex items-center justify-center gap-9 sm:gap-18 md:gap-10 lg:gap-12">
                            ...
                            <div className="fixed bottom-20 sm:bottom-32 left-4 sm:left-8 flex flex-col items-start justify-center gap-4">
                                {/* <MobileLink href="/projects">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" aria-hidden>
                                        ...
                                        <path fill="currentColor" d="M12.89 3H16a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H8a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.11a2 2 0 0 1 1.78 1.11Z" opacity=".5"/>
                                        <path fill="currentColor" d="M14 7a2 2 0 1 1-4 0a2 2 0 0 1 4 0"/>
                                        <path fill="currentColor" d="M9 13h6a.75.75 0 0 1 0 1.5H9A.75.75 0 0 1 9 13Z"/>
                                        <path fill="currentColor" d="M9 16h4a.75.75 0 0 1 0 1.5H9A.75.75 0 0 1 9 16Z"/>
                                    </svg>
                                    Projects
                                </MobileLink> */}
            ...
            <button
                type="button"
                onClick={() => setIsTerminalOpen(prev => !prev)} // Toggle terminal visibility
            ...
            >
                {/* <TerminalIcon className={clsx("transition-all duration-300 ease-in-out", isTerminalOpen ? "rotate-90" : "rotate-0")} />
                 */}
                <LiquidTerminalIcon src="/terminal_1.svg" className={clsx("transition-all duration-300 ease-in-out", isTerminalOpen ? "rotate-360" : "rotate-0")} />
            </button>

            <button type="button" onClick={() => setIsMenuOpen(prev => !prev)} className="w-10 sm:w-10 md:w-12 lg:w-12 h-fit text-white cursor-pointer hover:outline-2 focus-visible:outline-2 outline-offset-1 outline-zinc-100/20 focus-visible:outline-white rounded-lg">
                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 24 24" className={clsx("transition-all duration-300 ease-in-out w-10 h-10 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-12 lg:h-12", isMenuOpen ? "rotate-90" : "rotate-0")}>
